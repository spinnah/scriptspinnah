//
//  SettingsView.swift v0.20250626-145000
//  ScriptSpinnah
//
//  CS-151: Add pairing creation sheet with file/folder selection
//
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    TextField("Custom name for menu...", text: $newPairingDisplayName)
                        .textFieldStyle(.roundedBorder)
                }
            }
